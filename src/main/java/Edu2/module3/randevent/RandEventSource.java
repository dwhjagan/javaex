...
public final class RandEventSource 
{
	 ...
	 * @param evObj
	 */
	public void notifyListener(Edu.module3.randevent.RandEvent evObj)
	{
		...
		for (int i = 0; i < ITERATIONS; i++)
		{
			...
			*/
			...
			if (truncRandomNum%2 == 0) // Test for even number
			{
				...
				Edu.module3.randevent.RandEvent ev = new Edu.module3.randevent.RandEvent("10000th decimal place is even for random number = " + randomNum,
						evSource);
